    ...
    <table width="500" border="0" align="center">
      ...
      <tr>
        ...
        <td><label for="textfield4"></label>
          <input type="number" style="width:300px; " class="form-control" name="product_amount" value="<?= $result['product_amount'] ?>"  onkeypress="return isNumberKey(event)" id="product_amount"autocomplete="off" onpaste="return false;" onchange="if(this.value <= 0) {alert('จำนวนไม่สามารถน้อยกว่า 1'); this.value='1'; }" required /></td>
      </tr>
      <tr>

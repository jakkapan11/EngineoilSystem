    ...
    <table width="843" border="0" align="center">
      ...
      <tr>
        ...
        <td><label for="textfield3"></label>
          <input type="text" style="width:300px; " class="form-control" name="emp_phone" onkeypress="return isNumberKey(event)" id="emp_phone" minlength="10" maxlength="10" required /></td>
        <td>
      ...
      <tr>
        ...
        <td><label for="textarea"></label>
          <textarea name="emp_address" style="width:300px; " class="form-control" id="emp_address" required cols="30" rows="5"></textarea></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label for="select"></label>
          <select name="emp_level" style="width:300px; " class="form-control" id="emp_level" required>

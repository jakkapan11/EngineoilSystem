...
<body>
    <h2 class="page-header text-center" style="padding-top:90px;">รายงานการสั่งซื้อประจําเดือน</h2>
    <hr>
            ...
            <tr>
                ...
                <td><label for="select"></label>
                    <select name="year" style="width:300px; " class="form-control" id="year" required>
                        ...
                        $sql_year = "SELECT DISTINCT year(order_date) FROM orders WHERE order_date != '0000-00-00'";

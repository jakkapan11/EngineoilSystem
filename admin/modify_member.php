...
<body>
  <h2 class="page-header text-center" style="padding-top:80px;">แก้ไขข้อมูลสมาชิก</h2>
  <hr>
    ...
    <table width="815" border="0" align="center">
      ...
      <tr>
        ...
        <td><label for="textfield4"></label>
          <input type="email" style="width:300px; " class="form-control" name="cus_email" value="<?= $result['cus_email'] ?>" id="cus_email" required /></td>
